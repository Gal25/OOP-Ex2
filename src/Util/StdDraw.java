...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    public static void setGuiGraph(myGui Gui) {
        MyGui=Gui;
    }
...
//		}
        ...
        switch(str) {
            case "Draw graph" : MyGui.repaint();
                break;
            case "Save to file": MyGui.Savegraph();
                break;
            case "Load from file": MyGui.Loadgraph();
                break;
            case "Is Connected": MyGui.isConnected();
                break;
            case "Shortest Path Dist": MyGui.shortestPathDist();
                break;
            case "Shortest Path": MyGui.shortestPath();
                break;
            case "TSP": MyGui.TSP();
                break;
            default:
